...
puppet config set parser future --section agent     # this only applies for puppet v3.0+. It is not required in puppet version 4+
puppet config set parser future --section master     # this only applies for puppet v3.0+. It is not required in puppet version 4+
puppet config set parser future --section main     # this only applies for puppet v3.0+. It is not required in puppet version 4+
